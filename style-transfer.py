...
def run_style_transfer(content_path, style_path, num_iterations=200, content_weight=0.1, style_weight=0.9): 
  ...
  for i in range(num_iterations):
    ...
    # Save image after every 10 iterations 
    if (i+1)%10 == 0:
...
best, best_loss = run_style_transfer(content_path, style_path, content_weight=0.1, style_weight=0.9)