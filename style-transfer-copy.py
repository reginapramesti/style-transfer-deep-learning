...
def gram_matrix(features):
    ...
    """
    # Formula from http://math.uga.edu/~rothstei/6120Spring2008/GramMatrix20080325.pdf
...
def style_loss(style_matrix, generated_matrix):
    ...
    return K.sum(K.pow(style_mat - generated_mat, 2)) / (4 * (img_channels ** 2) * (img_size ** 2))
...
def total_loss(c_layer, s_layers, generated):
    ...
    return content_weight * c_loss + style_weight * s_loss + variation_weight * v_loss
